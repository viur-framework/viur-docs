...
latex_documents = [
    (master_doc, 'ViURCore.tex', u'ViUR Core Documentation',
     u'Mausbrand', 'manual'),
]
...
man_pages = [
    (master_doc, 'viurcore', u'ViUR Core Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ViURCore', u'ViUR Core Documentation',
     author, 'ViURCore', 'One line description of project.',
     'Miscellaneous'),
]
