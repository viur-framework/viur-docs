# -*- coding: utf-8 -*-
#
# viur-server documentation build configuration file, created by
...
project = u'ViUR Information System'
copyright = u'2017 Mausbrand Informationssysteme GmbH'
...
htmlhelp_basename = 'viur-serverdoc'
...
latex_documents = [
  ('index', 'viur-server.tex', u'viur-server Documentation',
   u'Mausbrand Informationssysteme GmbH', 'manual'),
]
...
man_pages = [
    ('index', 'viur-server', u'viur-server Documentation',
     [u'Mausbrand Informationssysteme GmbH'], 1)
]
...
texinfo_documents = [
  ('index', 'viur-server', u'viur-server Documentation',
   u'Mausbrand Informationssysteme GmbH', 'viur-server', 'One line description of project.',
   'Miscellaneous'),
]
...
#     print app, what, name, skip, options
#     return True
#
#
# def setup(app):
