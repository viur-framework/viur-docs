...
- The :class:`server.prototypes.list.List` prototype stores entities in a flat list,
- the :class:`server.prototypes.hierarchy.Hierarchy` prototype stores entities in a tree,
- the :class:`server.prototypes.tree.Tree` prototype store entities in a tree of folders,
- and the :class:`server.prototypes.singleton.Singleton` prototype ensures that only one entity per module exists.
